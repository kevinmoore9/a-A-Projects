...
var Root = function (_React$Component) {
  ...
  function Root(props) {
    ...
    setInterval(function () {
      return _this.tick(_this.state.hour, _this.state.minutes, _this.state.seconds);
    }, 1000);
    return _this;
  }
  ...
  _createClass(Root, [{
    key: 'tick',
    value: function tick(hours, minutes, seconds) {
      seconds += 1;
      if (seconds === 60) {
        seconds = 0;
        minutes += 1;
...
//
// setInterval(() => tick([hour, minutes, seconds]), 1000);
